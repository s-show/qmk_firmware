...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
  [_QWERTY] = LAYOUT(
      ...
      KC_IMEOFF, KC_ESC, KC_LALT, KC_LGUI, LOWER, KC_SPC,         KC_BSPC, RAISE, KC_APP,  KC_RGUI, KC_RALT,   KC_IMEON \
      ),

  [_LOWER] = LAYOUT( \
      _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,          KC_6,    KC_7,      KC_8,     KC_9,      KC_0,      KC_BSLS, \
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,         KC_F6,   KC_T_MINS, KC_T_EQL, KC_T_LBRC, KC_T_RBRC, KC_NO,   \
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,        KC_F12,  KC_APP,    _______,  KC_RALT,   KC_RGUI,   _______, \
      _______, _______, _______, _______, _______, _______,       KC_DEL,  ADJUST,    _______,  _______,   _______,   _______  \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, _______, ADJUST,  KC_NO,         KC_NO,   _______, _______,  _______,  _______, _______  \
      ),

    [_ADJUST] =  LAYOUT( \
      RESET,    KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,      KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,  KC_NO, \
      _______,  _______, _______, _______, _______, S(KC_RSFT),   DEBUG,   KC_NO,   KC_NO,   KC_CAD,  KC_APSCR, KC_PAUS,\
      _______,  _______, _______, _______, _______, KC_NO,        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    _______, \
