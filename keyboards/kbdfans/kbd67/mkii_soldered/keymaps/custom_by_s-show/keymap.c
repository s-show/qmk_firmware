...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all( /* Base */
	KC_ESC,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_BSPC, KC_LANG5,
	...
	KC_IMEOFF,KC_LGUI, KC_LALT,          KC_SPC,           MO(1),            KC_BSPC,           KC_APP, KC_IMEON,        KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [1] = LAYOUT_all( /* FN */
